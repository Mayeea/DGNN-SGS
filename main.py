...
from Build_Graph.build_graph_cosine_similarity import *

if __name__ == "__main__":

    parse = argparse.ArgumentParser()
    parse.add_argument("-d", "--dataset", default='citeseer', help="dataset", type=str)

    parse.add_argument("-l", "--labelrate", default='60', help="labeled data for train per class", type=int)
    ...
    print("输入特征的维度:", features.shape)

    model = DGNN_SGS(nfeat=config.fdim,
                      nhid1=config.nhid1,
                      nhid2=config.nhid2,
    ...
    def train(model, epochs):
        ...
        return loss.item(), acc_test.item(), macro_f1, emb_test
